const translations = {
    'en': {
        ...
        'telephone':'phone (+30) 6932323232'

    },

    'el': {
        // Navigation & General
        'welcome': 'Καλώς ήρθατε στο Τουρνουά Beach Volley του Ιονιού πανεπιστιμίου',
        'home': 'Αρχική',
        'about': 'Πληροφορίες',
        'register': 'Εγγραφή',
        ...
        'advice-text': 'Η μικτή κατηγορία μας έχει ως στόχο τη διασκέδαση και τη γνωριμία με νέο κόσμο. Ψάχνουμε συγκεκριμένα περισσότερα άτομα για τη μίξη — οπότε αν διστάζατε επειδή δεν είστε ακόμα "επαγγελματίες", αυτή είναι η κατάλληλη θέση για εσάς.',
        ...
        'place-time-text': 'Το τουρνουά θα πραγματοποιηθεί στις 23-24 Μαΐου (23 Μαΐου το Co-ed και 24 Μαΐου οι κατηγορίες Ανδρών και Γυναικών). Οι αγώνες θα διεξάγονται από τις 9 π.μ. έως τις 5 μ.μ.',

    //Contact us section
        'contact-us':'Επικοινωνία',
        'telephone':'Τηλέφωνο (+30) 6932323232'
    }
};
